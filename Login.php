                ...
                <div class="w-full p-6">
                    <form class="user" action="LoginProses.php" method="POST">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div class="w-full">
                                <input type="text" id="captcha" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Captcha" name="capctha_input">
                            </div>
